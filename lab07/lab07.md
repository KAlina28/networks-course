...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - Sequence Number: 0    (relative sequence number) Sequence Number (raw): 3865968786
   - есть [SYN] во флагах
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Sequence Number: 0    (relative sequence number) Sequence Number (raw): 1728555126
   - Acknowledgment Number: 1    (relative ack number) Acknowledgment number (raw): 344372168
   - Acknowledgment Number = Sequence Number + 1
   - есть [SYN, ACK] во флагах
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1 ; 644 ; 2092 ; 3540; 4988; 6436;
   - ![alt text](images/image-5.png)
   - ![alt text](images/image-6.png) (только для 3 есть)
   -  10.635046 - 10.781736 = -0.146690
      10.635225 - 10.781736 = -0.146511
      10.635232 - 10.781736 = -0.146504
      10.635234 - 10.781736 = -0.146502
      10.635235 - 10.781737 = -0.146502
      10.635236 - 10.781737 = -0.146501
...
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - <!-- todo -->
   - возьмем среднее rtt для 6 - 0.14650 ( из трех скриншотов выше )
   - window size = 2058 -> *6 = 12348 
   - 12348/0.1465 = 84286 б/с = 674288 бит/с = 674.29 кбит/с
